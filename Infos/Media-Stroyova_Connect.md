...
| Режим | Іконка | Коли використовувати |
|--------|--------|----------------------|
...
```
1️⃣ Tailscale  →  2️⃣ Вхід  →  3️⃣ macOS 🍎  або  4️⃣ Windows 🪟  →  ⚡ Швидка довідка
```
...
3. ✅ Переконайтесь, що статус **Connected** — зелена галочка = ви в мережі!

> [!IMPORTANT]
> Без схвалення адміна акаунт у Tailscale не побачить сервер. Якщо «Connected», а диск не відкривається — напишіть адміну 💬
